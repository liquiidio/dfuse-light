...
public class TrxOp
{
    public TrxOpOperation Operation;//            TrxOp_Operation    `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.eosio.codec.v1.TrxOp_Operation" json:"operation,omitempty"`
