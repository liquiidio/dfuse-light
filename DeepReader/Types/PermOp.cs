...
public class PermOp
{
    public PermOp_Operation Operation;//            PermOp_Operation  `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.eosio.codec.v1.PermOp_Operation" json:"operation,omitempty"`
