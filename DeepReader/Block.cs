...
public class Block
{
	...
	public RlimitOp[] RlimitOps;//                        []*RlimitOp                 `protobuf:"bytes,19,rep,name=rlimit_ops,json=rlimitOps,proto3" json:"rlimit_ops,omitempty"`
	...
	public TransactionReceipt[] UnfilteredTransactions;// []*TransactionReceipt `protobuf:"bytes,6,rep,name=unfiltered_transactions,json=unfilteredTransactions,proto3" json:"unfiltered_transactions,omitempty"`
	...
	public TrxOp[] UnfilteredImplicitTransactionOps;// []*TrxOp `protobuf:"bytes,20,rep,name=unfiltered_implicit_transaction_ops,json=unfilteredImplicitTransactionOps,proto3" json:"unfiltered_implicit_transaction_ops,omitempty"`
	...
	public TransactionTrace[] UnfilteredTransactionTraces;// []*TransactionTrace `protobuf:"bytes,21,rep,name=unfiltered_transaction_traces,json=unfilteredTransactionTraces,proto3" json:"unfiltered_transaction_traces,omitempty"`
